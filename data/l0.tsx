...
import { article, c, cm, code, cs, emp, f, fig, illustration, js, jsx, kw, link, lt, neg, note, paragraph, py, quote, section, sentence, v } from '../classes/shortcuts'
...
const example_dependencies = illustration('', code('JavaScript', ...[ // @todo L^0 language
...
const example_overlapping = illustration('', code('JavaScript', ...[ // @todo L^0 language
    [ kw('const'), ' ', v('x'), ' = ', lt('1'), ';' ],
    [ '' ],
