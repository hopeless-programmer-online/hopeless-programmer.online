...
export default  article(sentence('Мова програмування ', l0, '. '), ...[
    ...
    section('Форма запису. ', ...[
        ...
        paragraph(...[
            ...
            sentence('Оголошення функції ', js(f('my-function')), ' ми можемо записувати просто як ', js([ f('my-function'), '() {}' ]), ', вказуючи аргументи в круглих дужках, а інструкції в квадратних. '),
            sentence('Виклик ж функції можна записувати як і раніше, звичним способом: ', js([ f('my-function'), '()' ]), '. '),
        ]),
        paragraph(...[
