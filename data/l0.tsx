...
export default  article(sentence('Мова програмування ', l0, '. '), ...[
    ...
    section('Боротьба з перекриттям. ', ...[
        paragraph(...[
            ...
            sentence('Якщо ми оголосимо де-небудь змінну ', js(v('x')), ', то після цього ми можете оголосити змінну з таким же іменем у вкладеній області видимості. '),
    ...
    section('Передача продовжень. ', ...[
        ...
        paragraph(...[
            ...
            sentence('Які наслідки це за собою тягне? '),
