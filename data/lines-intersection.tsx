...
export default article(`Знаходження точки перетину прямих. `, {}, ...[
    section(`Навіщо це потрібно? `, ...[
        paragraph(...[
            ...
            sentence(`І це відносно легко зробити якщо представити м'яч у вигляді точки що рухається по прямій а перешкоду з якою він зіштовхується - у вигляді прямої обмеженої двома точками. `),
        ]),
    ]),
