...
export default article(`Знаходження точки перетину прямих. `, ...[
    ...
    section(`Обчислення. `, ...[
        paragraph(...[
            ...
            sentence(`Тепер перенесемо всі шукані доданки в праву частину рівняння та зробимо заміну (див. `, system_3, `) для відомих `, b_a, `, `, v_u, ` та `, u_a, `. `),
        ]),
        system_1,
        system_2,
        system_3,
    ...
    section(`Підсумки. `, ...[
        paragraph(...[
            ...
            sentence(`Кінцева формула для них (навіть для двовимірного випадку) є досить громіздкою (див. `, system_8, `). `),
            sentence(`Але, на щастя, для знаходження `, x, ` нам достатньо обчислити лише одне зі значень. `),
            sentence(``),
        ]),
        system_8,
        paragraph(...[
