...
export default article([ `Модель освітлення Ламберта.` ], {}, ...[
    ...
    section(`Розсіювання світла. `, ...[
        ...
        paragraph(...[
            ...
            sentence(`Якщо вважати, що сума усього світла з усіх напрямків `, Om, ` рівна `, tex(r`E_{\Omega}`), `, то сума світла яку можна буде спостерігати під тілесним кутом з площею `, om, ` повинна бути рівна `, tex(r`E_{\Omega} \frac{\omega}{\Omega}`), ` або `, tex(r`E_{\Omega} \frac{\omega}{2\pi}`), `. `),
    ...
    section(`Правило косинуса. `, ...[
        ...
        paragraph(...[
            ...
            sentence(`В загальному ж випадку - для не нормалізованих векторів - площа пропорційна до `, tex(r`\frac{ \vec{\omega} \cdotp \vec{n} }{ |\vec{\omega}| |\vec{n}| }`), `. `),
        ]),
        paragraph(...[
            sentence(``),
            sentence(``),
