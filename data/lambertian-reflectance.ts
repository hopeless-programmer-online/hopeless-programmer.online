...
export default article([ `Модель освітлення Ламберта.` ], {}, ...[
    ...
    section(`Кут огляду. `, ...[
        ...
        paragraph(...[
            sentence(`Якщо під кутом 0° в поле зору потрапляє площа поверхні рівна 10 одиницям, то під кутом 60° ці 10 одиниць поверхні будуть займати в полі зору вже `, tex(r`10 \cdot cos(60°)`), `, тобто 5 одиниць. `),
            ...
            sentence(`Таким чином, якщо ми розглядаємо поверхню яка займає все поле зору, то правило косинуса не буде мати на неї впливу. `),
        ]),
    ]),
    section(``, ...[
        paragraph(...[
