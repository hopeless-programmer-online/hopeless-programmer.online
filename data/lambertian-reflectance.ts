...
export default article([ `Модель освітлення Ламберта.` ], {}, ...[
    ...
    section(`Відбиття світла. `, ...[
        ...
        paragraph(...[
            ...
            sentence(`Оскільки світло не може ні потрапляти на поверхню, ні відбиватись `, fig(`вниз`), ` - під усіма сторонами ми будемо мати на увазі уявну півсферу розташовану над поверхнею. `),
            sentence(``),
            sentence(``),
        ]),
        paragraph(...[
