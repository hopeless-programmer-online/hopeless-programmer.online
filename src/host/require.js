    ...
    Document : s.document(s.sentence(`Все що я знаю про: `, $require, `. `), {},
        ...
        s.section(`Пошук. `, ...[
            ...
            s.paragraph(...[
                ...
                s.sentence(`Повний перелік ідентифікаторів цих модулів можна отримати за допомогою звернення до `, builtinModules, `. `),
            ...
            s.paragraph(...[
                ...
                s.sentence(`Це можливо, якщо в якості ідентифікатора модуля передати в функцію стрічку, що починається з косої риски (), крапки і косої риски (./), або двох крапок і косої риски (../). `),
                s.sentence(`В першому варіанті шлях буде трактуватись як глобальний, відносно кореня файлової системи. `),
                s.sentence(`У двох інших випадках - за аналогією з шляхом в файловій системі, `),
                s.sentence(` `),
                s.sentence(` `),
            ]),
        ]),
