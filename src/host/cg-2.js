    ...
    Document : document(
        ...
        section(`Буфер кадру та фрагменти.`, ...[
            ...
            paragraph(...[
                ...
                sentence(`Основною моделлю для роботи з виводом кольору на монітор є RGB або RGBA`, rgb, ` (Red - червоний, Green - зелений, Blue - синій та Alpha - альфа), у той час як, наприклад, при друці використовується CMY`, cmy, ` (Cyan - блакитний, Magenta - пурпурний, Yellow - жовтий). `),
            ]),
            [
                rgb,
                cmy,
        ...
        section(`Растеризація.`, ...[
            paragraph(...[
                // sentence(`Отож, графічні об'єкти представлені у вигляді векторних графічних примітивів, але все що ми можемо відобразити на екрані - це растрові пікселі. `),
