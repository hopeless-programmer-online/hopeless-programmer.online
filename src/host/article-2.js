    ...
    Document : s.document([ `Думки вголос. `, `Зарезервовані слова. ` ],
        ...
        s.section(`Претензії`, ...[
            s.paragraph(...[
                ...
                s.sentence(`Інколи це змушує вводити в мову дещо `, s.figurative(`кострубаті`), ` і неприродні конструкції `, code_2, `. `),
        ...
        s.section(`Виділення ідентифікаторів`, ...[
            s.paragraph(...[
                ...
                s.sentence(`Як і в попередньому випадку тут заборонені `, s.figurative(`порожні`), ` змінні та символ `, s.lexeme(`$`), ` всередині ідентифікатора, але в цілому підхід є більш повним. `),
        ...
        s.section(`Виділення ключових слів`, ...[
            s.paragraph(...[
                ...
                s.sentence(`Замість того щоб `, s.figurative(`виділяти`), ` ідентифікатори можна виділити службові слова. `),
        ...
        s.section(`Змішаний підхід`, ...[
            s.paragraph(...[
                ...
                s.sentence(`Натомість вони перетворюються на деякі `, s.figurative(`іменовані`), ` об'єкти, до яких можна звертатись через ідентифікатори. `),
                s.sentence(`Оголошення і визначення цих об'єктів залишається `, s.figurative(`за кадром`), `, але робота з ідентифікаторами що на них посилаються нічим не відрізняється від роботи з будь-якими іншими ідентифікаторами. `),
