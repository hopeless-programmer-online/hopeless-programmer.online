    ...
    Document : s.document([ `Думки вголос. `, `Зарезервовані слова. ` ],
        ...
        s.section(`Виділення ідентифікаторів`, ...[
            s.paragraph(...[
                ...
                s.sentence(`Змінні в ній виділені в окрему синтаксичну категорію і починаються з символу "$" `, code_5, `. `),
        ...
        s.section(`Виділення ключових слів`, ...[
            ...
            s.paragraph(...[
                ...
                s.sentence(`Так, наприклад, мови розмітки XML та HTML використовують кутові дужки ("<" та ">") для запису теґів `, code_10, `. `),
