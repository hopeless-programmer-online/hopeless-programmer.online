...
exports = module.exports = new h.DocumentResource({
    Document : s.document([ `Думки вголос. `, `Цифрова сегрегація ідентифікаторів.` ],
        {
            Date : new Date(`2019-08-20T00:00:00.000Z`),
        },
        section(``, ...[
            paragraph(...[
        ...
        section(`Ідентифікатори та літерали.`, ...[
            paragraph(...[
                ...
                sentence(`В той час як ідентифікатори позначають змінні`, note([ `Деколи використовують й інше формулювання, яке зводиться до того, що ідентифікатори позначають "сутності мови". `, `Це часто залежить ще й від того, чи можливо розглядати ідентифікатори функцій та класів як звичайні змінні в контексті конкретної мови. ` ]), ` літерали призначені для запису чисел, стрічок та інших об'єктів з певними сталими формами запису. `),
                sentence(`Цікаво те, що правила запису ідентифікаторів мають низку нюансів та виключень. `),
                sentence(`Якщо не приймати до уваги особливостей окремих мов то можна сформулювати наступні умови зовнішнього вигляду ідетифікаторів: `),
            ]),
            list(...[
                ...
                `Ідетнифікатор повинен не співпадати зі службовими словами та літералами. `,
            ...
            paragraph(...[
                ...
                sentence(`Друга - надає особливий статус службовим словам які в переважній більшості випадків задовільняють першу умову. `),
            ...
            paragraph(...[
                ...
                sentence(`Але в класичному розумінні слова true, false та null є літералами`, note(`Хоча конкретно зі статусом null можна і посперечатись, хтось може вважати його службовим словом. `), `, а тому їх потрібно вводити в якості окремого виключення з правил. `),
            ...
            paragraph(...[
                ...
                sentence(`Навіть якщо в мові присутні числа з літерами (вже згадані 0u та 0f) то такі співпадіння можна виключити другою умовою, яка забороняє ідентифікаторам збігатись з літералами. `),
                sentence(`Окрім цього таке обмеження робить неможливим існування ідентифікаторів які не конфліктують з літералами, на кшталт 1st, 2nd, 2D, 3D`, note([ `Ідентифікатори 2D, 3D та інші подібні до них зазвичай неможливо сплутати з шіснадцятковим представленням чисел. `, `Останнє часто має сцецифічний префікс (0х) або постфікс (h), які відрізняють їх від десяткових форм у випадку відсутності цифр більших від 9-ти. `, `Наприклад, число 45 в шіснадцятковій формі буде записано як 0х2D або 2Dh, але не як 2D. ` ]), ` та інших. `),
        ...
        section(`Аргументація...`, ...[
            paragraph(...[
                ...
                sentence(`Навіть якщо закрити очі на С/С++ та їхні 0u і 0f, то залишається низка інших мов з двійковою (101b) та шіснадцятковою (101h`, note(`Така форма запису без префіксу 0х деколи використовується в ассемблері. `), ` або 0x101) формою запису чисел, а також спеціальною формою запису експоненти (1е10). `),
                sentence(`Якщо дозволити ідентифікатори що починаються з цифри але не конфліктують з літералами то з'явиться величезна`, note([ `Насправді кількість таких виключень ще й потенційно нескінченна, оскільки чисел існує нескінченно багато. `, `Від цього рятує лише скінченність пам'яті самого комп'ютера. ` ]), ` кількість "виключень з правил". `),
            ]),
            paragraph(...[
                sentence(`Ще один популярний аргумент налогошує на тому що такий підхід полегшує написання транслятора та засобів для підсвітки синтаксису в редакторах. `),
                sentence(`Якщо числа завжди починаються з цифри`, note([ `За такого формулювання можна вважати що аналіз від'ємного числа не включає в себе символ мінус і аналізує його окремо, як оператор. `, `Також можна окремо аналізувати форму запису яка починається з крапки (.0f або .5). ` ]), ` то на етапі синтаксичного аналізу можна ще з першого символу віднести їх до окремої категорії токенів. `),
                sentence(`Якщо ж вводити виключення для допустимих ідентифікаторів які не створюють конфліктів - то може бути проблематично вказати такі правила синтаксичного аналізу при використанні стандартних засобів - регулярних виразів`, note(`Що свідчить зовсім не на користь сучасних регулярних виразів. `), `. `),
        ...
        section(`...з якою я не згідний.`, ...[
            paragraph(...[
                ...
                sentence(`Навіть якщо закрити очі на це то незмінним залишається той факт що більшість сучасних мов все ж дозволяють перектиття, хоч і не надають мехінізмів для боротьби з ним. `),
            ...
            paragraph(...[
                ...
                sentence(`Мене не влаштовує вийнятковий статус цифр в питанні оголошення ідентифікаторів. `),
        ...
        section(`Реальні приклади?`, ...[
            paragraph(...[
                sentence(`Не зважаючи на те що цю проблему можна було б вирішити вийнятково з академічного інтересу, завжди знайдуться люди яким буде цікаво побачити хоча б один реальний приклад використання таких числових ідентифікаторів. `),
                sentence(`І одразу ж можна привести вже згадані ідентифікатори для позначення порядку або пріоритету: 1st, 2nd, 3rd, 4th, 5th і т.д.`, note(`Є і більш не серйозні приклади, на кшталт wait(4ever). `), `. `),
        ...
        section(`Літеральні ідентифікатори.`, ...[
            paragraph(...[
                sentence(`А все ж можна було б обіграти зовсім по іншому, не перетворюючи числа та стрічки на вийнятки з правил. `),
            ...
            paragraph(...[
                ...
                sentence(`Якщо ж мова дозволяє перекривати ідентифікатори у вкладених областях`, note([ `Не у всіх мовах це можливо. `, `Наприклад, в C# перекриття локальних змінних заборонено. ` ]), ` то стають доступними і звичайні числа та стрічки. `),
            ...
            paragraph(...[
                ...
                sentence(`Важливо врахувати і те що сучасні середовища розробки могли б при потребі не відображати лапки навколо тексту. `),
            ...
            paragraph(...[
                ...
                sentence(`Якщо в конкретій області ідентифікатор не був оголошений і його текст може бути інтерпретований як число - він інтерпретується як число. `),
        ...
        section(`Висновки.`, ...[
            paragraph(...[
                ...
                sentence(`Сьогоднішній підхід до літералів породжує не достатньо виправдані вийнятки в дизайні мов та робить роботу з ідентифікаторами неоднорідною. `),
