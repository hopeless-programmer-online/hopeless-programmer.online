...
exports = module.exports = new h.DocumentResource({
    Document : s.document([ `Думки вголос. `, `Незворотне перекриття ідентифікаторів. ` ],
        ...
        s.section(`Проблематика`, ...[
            ...
            s.paragraph(...[
                s.sentence(`В приведеному коді `, code_1, ` змінна `, /*code(`C++`, code.line(`х`)),*/ ` перекриває аргумент `, /*code(`C++`, code.line(`х`)),*/ `. `),
        ...
        s.section(`Часткові рішення`, ...[
            s.paragraph(...[
                ...
                s.sentence(`В С++ для цього використовується оператор `, /*code(`C++`, code.line(`::`)),*/ ` `, code_4, `. `),
                s.sentence(`Щоб виконати таке в Python змінна повинна бути оголошена через ключове слово `, /*code(`Python`, code.line(code.kw(`global`))),*/ ` `, code_5, `. `),
                s.sentence(`А в JavaScript `, /*code(`JavaScript`, code.line(`global`)),*/ ` виступає спеціальним об'єктом, який містить в собі усі `, s.emphasis(`глобальні`), ` об'єкти в якості полів `, code_6, `. `),
            ]),
            [
                code_4,
                code_5,
        ...
        s.section(`Звернення через зовнішню область`, ...[
            s.paragraph(...[
                ...
                s.sentence(`Наприклад, аргументи функції можуть бути отримані через `, /*emphasis(`однойменний`),*/ ` префікс `, code_11, `. `),
            ]),
            [
                code_10,
                code_11,
            ...
            s.paragraph(...[
                ...
                s.sentence(`Окремо варто зазначити, що це також вирішило б проблему виходу з декількох циклів `, code_13, `, оскільки команда `, /*code(`C++`, code.line(code.kw(`break`))),*/ ` теж виступає заручником механізму перекриття. `),
            ]),
            [
                code_12,
                code_13,
