    ...
    Document : document([sentence(`Програмування комп'ютерної графіки. `), sentence(`Вступ.`) ], {},
        ...
        section(`Графічний прискорювач.`, ...[
            ...
            paragraph(...[
                ...
                sentence(`Вже у 2008 їх поглинула NVidia і розрахунком фізики почав займатись PhysX на їхніх відеокартах. `),
            ...
            paragraph(...[
                ...
                sentence(`Так, наприклад, NVidia RTX TITAN усього містить 4608 ядра CUDA. `),
            ]),
            paragraph(...[
