    ...
    Document : document(sentence(`Все що я знаю про: `, $require, `. `), {},
        ...
        section(`Проблеми: порядок завантаження та циклічні залежності.`, ...[
            ...
            paragraph(...[
                ...
                sentence(`Достатньо лише розмістити виклик `, require_pong , ` після експорту, щоб `, ping, ` почала завантажувати `, pong, ` лише після того як сама експортувала себе. `),
            ...
            paragraph(...[
                sentence(`За таких умов всі модулі зможуть правильно експортувати свій вміст ще до того як почнуть завантажувати інших, що і усуне проблему. `),
                sentence(``),
                sentence(``),
            ]),
            paragraph(...[
