...
import { article, c, code, cs, emp, f, fig, js, jsx, kw, link, lt, neg, paragraph, quote, section, sentence, v } from '../classes/shortcuts'
...
const model = article(sentence('Мова програмування ', l0, '. '), ...[
    ...
    section('Мовна різниця. ', ...[
        paragraph(...[
            ...
            sentence('Десь можливе перевантаження функцій чи операторів, десь підтримуються шаблони, десь підпрограми та асинхронний код і т.і. '),
        ...
        paragraph(...[
            ...
            sentence('Вона стосується роботи з колекціями і є синтаксичним цукром який загалом зводиться до простої заміни тексту програми. '),
        ...
        paragraph(...[
            ...
            sentence('Дуже схожа ситуація склалась з мовою JavaScript XML, яка дає можливість запису HTML/XML-подібних теґів всередині звичайного JavaScript коду. '),
            sentence('Як і у випадку з linq все зводиться до заміни тексту. '),
            sentence('Наприклад, вираз ', jsx([ '<', kw('span'), ' ', v('className'), '=', lt('"red"'), '>red text</span>' ]), ' буде замінено на ', js([ c('React'), '.', f('createElement'), '(', lt('"span"'), ', { ', v('className'), ' : ', lt('"red"'), ' }, ', lt('"red text"'), ')' ]), ', тобто JSX це теж лише зручність але ніяк не новий функціонал. '),
            sentence(''),
            sentence(''),
        ]),
        paragraph(...[
